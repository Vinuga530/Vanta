                  ...
                  child: GlassCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Avg ${_fmt(_weeklyStats.isEmpty ? 0 : _weeklyStats.fold<int>(0, (s, e) => s + e.totalMinutes) ~/ _weeklyStats.length)} / day',
                          ...
                          child: BarChart(
                            BarChartData(
                              ...
                              barTouchData: BarTouchData(
                                touchCallback: (e, r) {
                                  if (r?.spot != null && e is FlTapUpEvent) {
                                    setState(
                                      () => _selectedDay =
                              ...
                              barGroups: List.generate(
                                ...
                                (i) => BarChartGroupData(
                                  ...
                                  barRods: [
                                    BarChartRodData(
                                      toY: _weeklyStats[i].totalMinutes
                                          .toDouble(),
                                      color: i == _selectedDay
                                          ? CupertinoColors.activeBlue
                                          : (isDark
          ...
          IOSListTile(
            leading: Container(
              ...
              decoration: BoxDecoration(
                color: _appColor(a.packageName),
                borderRadius: BorderRadius.circular(7),
              ),
              alignment: Alignment.center,
              child: Text(
                a.appName.isNotEmpty ? a.appName[0].toUpperCase() : '?',
                style: const TextStyle(
                  color: Colors.white,
